/**
 * Prompt for outbound messages when INPUT_MODE is 'companies'.
 * Same as persons prompt but without the Manifest opener (step 1).
 * Used in writeOutboundMessage (bot.js).
 */

export function getCompaniesOutboundPrompt(info) {
